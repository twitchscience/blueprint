...
func main() {
	...
	apiProcess := api.New(*staticFileDir, bpdbBackend, bpSchemaBackend, bpKinesisConfigBackend, bpEventCommentBackend, bpEventMetadataBackend, *configFilename, ingCont, *slackbotURL, *readonly)
